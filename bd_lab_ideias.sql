...
(5, 'Ivan Lucas Schaurich', 'bolsista'),
(6, 'Guilherme Martins Glaeser', 'voluntário'),
(7, 'Moser Silva Fagundes', 'colaborador'),
(8, 'Guilherme Martins Glaeser', 'bolsista'),
(9, 'Ivan Lucas Schaurich', 'voluntário'),
(10, 'Kauã Klassmann', 'bolsista'),
(11, 'Eloisa Rambo Winter', 'bolsista'),
(12, 'Thais Hillebrand Link', 'bolsista'),
(13, 'Lucas Marques Gritti', 'voluntário'),
(14, 'Michel Nathan Schauren', 'bolsista'),
(15, 'Alan Eduardo Federhen', 'voluntário');
...
--
-- Despejando dados para a tabela `realiza`
--
