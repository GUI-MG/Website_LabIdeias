...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete'])) {
    ...
    try {
        $conn->query("DELETE FROM participa WHERE fk_projeto_id = $id");
        $conn->query("DELETE FROM realiza WHERE fk_projeto_id = $id");
    ...
    header('Location: dashboard_projetos.php');
    exit;
}
...
<body>
    ...
    <main class="container py-5">
        <div class="text-center d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="cadastro_projetos.php" class="btn btn-success"><i class="bi bi-plus-lg"></i> Cadastrar novo
                projeto</a>
        </div>
